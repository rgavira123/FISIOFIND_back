...
export default function GestionarPacientes() {
  ...
  useEffect(() => {
    axios
      .get("http://${getApiBaseUrl()}/api/app_user/admin/patient/list/")
      .then((response) => {
  ...
  return (
    <>
      ...
      <div className="terminos-container">
        <a href="/gestion-admin/citas/create">
            ...
            pacientes.map(function (paciente, key) {
              return (
                <div key={key} className="termino-list-view">
                  ...
                  <a
                    href={
                      "/gestion-admin/usuarios/pacientes/view/" + paciente.id
                    }
                  >
                  ...
                  <a
                    href={
                      "/gestion-admin/usuarios/pacientes/edit/" + paciente.id
                    }
                  >
                  ...
                  <a
                    href={
                      "/gestion-admin/usuarios/pacientes/delete/" + paciente.id
                    }
                  >
