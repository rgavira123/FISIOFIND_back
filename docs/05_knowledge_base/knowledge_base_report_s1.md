---
title: "REPORTE BASE DE CONOCIMIENTO #S1"                       # CHANGE IF NEEDED
...
header-left: "REPORTE BASE DE CONOCIMIENTO #S1"                 # CHANGE IF NEEDED
...
<h1 align="center" style="font-size: 30px; font-weight: bold;">
  FISIO FIND  -  REPORTE BASE DE CONOCIMIENTO #S1
</h1>
...
- [3. USO Y GESTIÓN DE LA BASE DE CONOCIMIENTO](#3-uso-y-gestión-de-la-base-de-conocimiento)
  - [3.1. USO Y GESTIÓN GRUPAL](#31-uso-y-gestión-grupal)
    - [3.2.1. Organización](#31-organización)
    - [3.2.2. Planificación](#32-planificación)
    - [3.2.3. Informes](#32-informes)
    - [3.2.4. Seguimiento](#33-seguimiento)
    - [3.2.5. Recursos](#34-recursos)
    - [3.2.6. Ideando un proyecto](#35-ideando-un-proyecto)
...
- [4. CONTRIBUCIONES DEL EQUIPO](#4-contribuciones-del-equipo)
  - [4.1. CONTRIBUCIONES A LA BASE DE CONOCIMIENTO GRUPAL](#41-contribuciones-a-la-base-de-conocimiento-grupal)
    ...
    - [4.1.3. Informes](#413-informes)
      - [4.1.3.1. Informes de tiempo](#4131-informes-de-tiempo)
      - [4.1.3.2. Informes de IA](#4132-informes-de-ia)
    - [4.1.4. Seguimiento](#414-seguimiento)
      - [4.1.4.1. Reuniones](#4141-reuniones)
      - [4.1.4.2. Sprint 1](#4142-sprint-1)
    - [4.1.5. Recursos](#415-recursos)
      - [4.1.5.1. Feedbacks](#4151-feedbacks)
