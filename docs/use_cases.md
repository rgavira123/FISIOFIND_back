| **ID**                 | CU-01: Perfil profesional con certificaciones verificadas |
| ---------------------- | --------------------------------------------------------- |
| **Versión**            | V1.0                                                      |
| **Prioridad**          | Importante                                                |
| **Escenario**          | 1. Un profesional se registra en la plataforma desde la sección de fisios.<br>2. Carga las certificaciones en formato digital (PDF, JPG, PNG).<br>3. El sistema valida las certificaciones mediante un proceso de verificación.<br>4. Si las certificaciones son válidas, se marcan como "Verificadas".<br>5. Se muestra un mensaje de confirmación: "Certificaciones verificadas exitosamente"<br>6. Se finaliza el registro del profesional |
...
| **ID**                 | CU-025: Aceptación exitosa de términos y condiciones sobre responsabilidad |
| ---------------------- | ------------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                      |
| **Prioridad**          | Importante                                                               |
| **Escenario**          | 1. Un paciente accede a la plataforma y comienza el proceso de registro.<br>2. Llega a la sección de “Términos y Condiciones” y los revisa.<br>3. Marca la casilla de aceptación de responsabilidad sobre la realización autónoma de los ejercicios.<br>4. Continúa con el registro y finaliza la creación de su cuenta.<br>5. El sistema almacena el consentimiento del usuario.<br>6. Se muestra un mensaje de confirmación: "Registro completado con éxito". |
| **Resultado Esperado** | - El paciente acepta los términos correctamente.<br>- El sistema almacena la aceptación para futuras referencias.<br>- No se permite continuar el registro sin la aceptación de los términos. |

<div align="center"> <b>Tabla 25: Caso de uso positivo de RF-013</b></div>
<br>


| **ID**                 | CU-026: Fallo en la aceptación de términos y condiciones sobre responsabilidad |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                          |
| **Prioridad**          | Importante                                                                    |
| **Escenario**          | 1. Un paciente accede a la plataforma y comienza el proceso de registro.<br>2. Llega a la sección de “Términos y Condiciones” y los revisa.<br>3. Intenta continuar sin marcar la casilla de aceptación.<br>4. El sistema detecta que no ha aceptado los términos y bloquea el avance.<br>5. Se muestra un mensaje de error: "Debe aceptar los términos y condiciones para completar el registro".<br>6. El paciente no puede finalizar su registro hasta aceptar los términos. |
| **Resultado Esperado** | - Se impide el registro sin la aceptación de los términos.<br>- El sistema informa al usuario sobre la obligatoriedad de la aceptación.<br>- Se garantiza que todos los pacientes aceptan los términos antes de usar la plataforma. |

<div align="center"> <b>Tabla 26: Caso de uso negativo de RF-013</b></div>
<br>

| **ID**                 | CU-027: Inicio de sesión exitoso con correo y contraseña o autenticación social |
| ---------------------- | ----------------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                          |
| **Prioridad**          | Crítica                                                                       |
| **Escenario**          | 1. Un usuario accede a la plataforma e ingresa su correo y contraseña.<br>2. El sistema valida las credenciales y permite el acceso.<br>3. Alternativamente, el usuario selecciona el inicio de sesión con un proveedor de autenticación social (Google, Facebook, etc.).<br>4. Es redirigido a la plataforma del proveedor, donde otorga los permisos necesarios.<br>5. El sistema recibe la validación del proveedor y concede el acceso al usuario.<br>6. Se muestra un mensaje de confirmación: "Inicio de sesión exitoso". |
| **Resultado Esperado** | - El usuario puede acceder correctamente mediante distintos métodos de autenticación.<br>- El sistema almacena la sesión de manera segura.<br>- Se garantiza una experiencia de inicio de sesión fluida y segura. |

<div align="center"> <b>Tabla 27: Caso de uso positivo de RF-014</b></div>
<br>


| **ID**                 | CU-028: Fallo en el inicio de sesión con correo y contraseña o autenticación social |
| ---------------------- | ---------------------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                               |
| **Prioridad**          | Crítica                                                                            |
| **Escenario**          | 1. Un usuario accede a la plataforma e ingresa su correo y contraseña.<br>2. Introduce credenciales incorrectas y el sistema las rechaza.<br>3. Alternativamente, intenta acceder con un proveedor de autenticación social.<br>4. La autenticación con el proveedor falla debido a credenciales inválidas o falta de permisos.<br>5. Se muestra un mensaje de error: "Inicio de sesión fallido. Verifique sus credenciales e inténtelo de nuevo".<br>6. El usuario no puede acceder a la plataforma hasta ingresar credenciales válidas. |
...
<div align="center"> <b>Tabla 28: Caso de uso negativo de RF-014</b></div>
<br>
...
<div align="center"> <b>Tabla 29: Caso de uso positivo de RF-015</b></div>
<br>
...
<div align="center"> <b>Tabla 30: Caso de uso negativo de RF-015</b></div>
<br>
...
<div align="center"> <b>Tabla 31: Caso de uso positivo de RF-016</b></div>
<br>
...
<div align="center"> <b>Tabla 32: Caso de uso negativo de RF-016</b></div>
<br>
...
<div align="center"> <b>Tabla 33: Caso de uso positivo de RF-017</b></div>
<br>
...
<div align="center"> <b>Tabla 34: Caso de uso negativo de RF-017</b></div>
<br>
...
<div align="center"> <b>Tabla 35: Caso de uso positivo de RF-018</b></div>
<br>
...
<div align="center"> <b>Tabla 36: Caso de uso negativo de RF-018</b></div>
<br>
...
<div align="center"> <b>Tabla 37: Caso de uso positivo de RF-019</b></div>
<br>
...
<div align="center"> <b>Tabla 38: Caso de uso negativo de RF-019</b></div>
<br>
...
<div align="center"> <b>Tabla 39: Caso de uso positivo de RF-020</b></div>
<br>
...
<div align="center"> <b>Tabla 40: Caso de uso negativo de RF-020</b></div>
<br>
...
<div align="center"> <b>Tabla 41: Caso de uso positivo de RF-021</b></div>
<br>
...
<div align="center"> <b>Tabla 42: Caso de uso negativo de RF-021</b></div>
<br>
...
<div align="center"> <b>Tabla 43: Caso de uso positivo de RF-022</b></div>
<br>
...
<div align="center"> <b>Tabla 44: Caso de uso negativo de RF-022</b></div>
<br>
...
<div align="center"> <b>Tabla 45: Caso de uso positivo de RF-023</b></div>
<br>
...
<div align="center"> <b>Tabla 46: Caso de uso negativo de RF-023</b></div>
<br>

| **ID**                 | CU-047: Uso exitoso de explicaciones visuales interactivas de recomendaciones |
| ---------------------- | ---------------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                         |
| **Prioridad**          | Importante                                                                   |
| **Escenario**          | 1. Un fisioterapeuta accede a la plataforma e inicia sesión.<br>2. Se dirige a la sección de explicaciones visuales interactivas.<br>3. Selecciona un paciente y carga una herramienta visual interactiva para explicar una recomendación.<br>4. Utiliza modelos 3D, anotaciones o dibujos en pantalla para aclarar la recomendación.<br>5. El paciente puede interactuar con la explicación visual en su sesión.<br>6. Se muestra un mensaje de confirmación: "Explicación interactiva enviada correctamente". |
| **Resultado Esperado** | - El fisioterapeuta puede transmitir sus recomendaciones de manera visual e interactiva.<br>- El paciente comprende mejor el tratamiento gracias a la herramienta visual.<br>- Se mejora la comunicación entre profesional y paciente. |

<div align="center"> <b>Tabla 47: Caso de uso positivo de RF-024</b></div>
<br>

| **ID**                 | CU-048: Fallo en la funcionalidad de explicaciones visuales interactivas |
| ---------------------- | ----------------------------------------------------------------------- |
| **Versión**            | V1.0                                                                   |
| **Prioridad**          | Importante                                                             |
| **Escenario**          | 1. Un fisioterapeuta accede a la plataforma e inicia sesión.<br>2. Se dirige a la sección de explicaciones visuales interactivas.<br>3. Intenta seleccionar una herramienta visual, pero el sistema no la carga correctamente.<br>4. Intenta enviar una explicación al paciente, pero la herramienta no responde.<br>5. Se muestra un mensaje de error: "No se ha podido cargar la herramienta interactiva. Inténtelo más tarde".<br>6. El fisioterapeuta debe explicar las recomendaciones sin apoyo visual. |
| **Resultado Esperado** | - Se notifica al usuario del error sin comprometer la sesión en curso.<br>- Se evita el uso de herramientas defectuosas.<br>- Se permite reintentar el uso de la función cuando el sistema esté disponible. |

<div align="center"> <b>Tabla 48: Caso de uso negativo de RF-024</b></div>
<br>
...
<div align="center"> <b>Tabla 49: Caso de uso positivo de RF-025</b></div>
<br>
...
<div align="center"> <b>Tabla 50: Caso de uso negativo de RF-025</b></div>
<br>
...
<div align="center"> <b>Tabla 51: Caso de uso positivo de RF-026</b></div>
<br>
...
<div align="center"> <b>Tabla 52: Caso de uso negativo de RF-026</b></div>
<br>
...
<div align="center"> <b>Tabla 53: Caso de uso positivo de RF-027</b></div>
<br>
...
<div align="center"> <b>Tabla 54: Caso de uso negativo de RF-027</b></div>
<br>
...
<div align="center"> <b>Tabla 55: Caso de uso positivo de RF-028</b></div>
<br>
...
<div align="center"> <b>Tabla 56: Caso de uso negativo de RF-028</b></div>
<br>
...
<div align="center"> <b>Tabla 57: Caso de uso positivo de RF-029</b></div>
<br>
...
<div align="center"> <b>Tabla 58: Caso de uso negativo de RF-029</b></div>
<br>
...
<div align="center"> <b>Tabla 59: Caso de uso positivo de RF-030</b></div>
<br>
...
<div align="center"> <b>Tabla 60: Caso de uso negativo de RF-030</b></div>
<br>
...
<div align="center"> <b>Tabla 61 : Caso de uso positivo de RF-031</b></div>
<br>
...
<div align="center"> <b>Tabla 62: Caso de uso negativo de RF-031</b></div>
<br>
...
<div align="center"> <b>Tabla 63: Caso de uso positivo de RF-032</b></div>
<br>
...
<div align="center"> <b>Tabla 64: Caso de uso negativo de RF-032</b></div>
<br>
...
<div align="center"> <b>Tabla 65: Caso de uso positivo de RF-033</b></div>
<br>
...
<div align="center"> <b>Tabla 66: Caso de uso negativo de RF-033</b></div>
