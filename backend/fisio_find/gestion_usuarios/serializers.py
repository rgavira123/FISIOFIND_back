...
class PhysioRegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'birth_date', 'collegiate_number', 'autonomic_community', 'phone_number',
            'postal_code', 'specializations'
        ]
    ...
    def create(self, validated_data):
        try:
            with transaction.atomic():
                ...
                for specialization_name in specializations_data:
                    specialization, _ = Specialization.objects.get_or_create(name=specialization_name)
                    physio.specializations.add(specialization)
