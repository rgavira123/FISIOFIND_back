...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('physiotherapist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='physio_specializations', to='gestion_usuarios.physiotherapist')),
                ('specialization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='gestion_usuarios.specialization')),
            ],
        ),
        migrations.AddField(
            model_name='physiotherapist',
            name='specializations',
            field=models.ManyToManyField(through='gestion_usuarios.PhysiotherapistSpecialization', to='gestion_usuarios.specialization'),
        ),
    ]
