# Generated by Django 5.1.6 on 2025-03-12 15:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patient_appointments', to='gestion_usuarios.patient', verbose_name='Patient')),
                ('physiotherapist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='physio_appointments', to='gestion_usuarios.physiotherapist', verbose_name='Physiotherapist')),
            ],
            options={
